...
class MACD:
    ...
    def plot(self, title=None, plot_height=400, plot_width=800):#, p=None):
        p1 = create_default_panel(plot_height=plot_height, plot_width=plot_width)
        p2 = create_default_panel(plot_height=int(plot_width/2), plot_width=plot_width)
        ...
        p1.line(self.data['numerical_index'], self.data[self.series_name],
               legend=self.series_name, color='skyblue')
